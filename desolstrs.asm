...
SCR40: DEFM "Ported to Korvet",0
SCR41: DEFM "by nzeemin, 2024",0
...
SE0A7: DEFM "Arrows: Movement|Space/Alf/Grf: Look/shoot|I M: Inventory|Tab/Sel: Look/shoot mode|"
       DEFM "PRF: Close pop-ups|STP: Quit to Menu",0
